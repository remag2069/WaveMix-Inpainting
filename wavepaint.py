...
parser.add_argument("-save", "--img_save_folder", default="CelebHQ_Model_generated_images", help = "Path to save images generated by model")
parser.add_argument("-batch", "--Batch_size", default=160, help = "Batch Size")
parser.add_argument("-train_dir", "--train_directory", default='celebhq/train', help = "Batch Size")
...
in_dir				= str(args.train_directory)

Image_size 			= 224


TrainDataLoaderConfig = 	{	'indir'				: 	in_dir,
								'out_size'			:	 Image_size,
...
eval_loader	=	make_default_val_dataloader(	indir		= "ImageNet/test/",
					  							img_suffix	= ".png", 
												out_size	= Image_size,
...
# PATH = 'model.pth
# PATH = base_path + '_blocks'+str(NUM_BLOCKS)+'_dim'+str(MODEL_EMBEDDING)+'_modules'+str(NUM_MODULES)+'_celebhq.pth'
...
summary(model, input_size= [(1, 3, Image_size,Image_size),(1, 1,Image_size,Image_size)], col_names= ("input_size","output_size","num_params"), depth = 6)
###########################################################################################################################################
